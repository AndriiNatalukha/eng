                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            >
                                <div>
                                    ...
                                    <img
                                        src='/storage/img/icons8-грамматика-50.png'
                            ...
                            >
                                <div>
                                    <div className="h-16 w-16 bg-blue-50 dark:bg-blue-800/20 flex items-center justify-center rounded-full">
                                    <img
                                        src='/storage/img/icons8-язык-100.png'
                                        alt="Опис вашого зображення"
                                        className="h-30 w-30 object-contain"
                                    />
                                    </div>
                            ...
                            >
                                <div>
                                    <div className="h-16 w-16 bg-blue-50 dark:bg-blue-800/20 flex items-center justify-center rounded-full">
                                    <img
                                        src='/storage/img/icons8-штанга-100.png'
                                        alt="Опис вашого зображення"
                                        className="h-30 w-30 object-contain"
                                    />
                                    </div>
                                    ...
                                    <h2 className="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
                                        Тренажер вивчення слів
                                    </h2>

                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        В цьому розділі ви зможете поліпшити свої знання англійської мови за допомогою тренажера для вивчення слів.
                                    </p>
                                </div>
